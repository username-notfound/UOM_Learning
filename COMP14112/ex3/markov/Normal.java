...
public class Normal {
    ...
    /** 
     * Method to combine two normal densities by averaging their mean and variance
     */

    public Normal combine(Normal norm) {

        return new Normal((mean+norm.mean)/2.0,(variance+norm.variance)/2.0);
    }
}
